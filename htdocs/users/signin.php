...
<html lang="en">
   <head>
      ...
      <title>Sign in - Cloud Labs</title>
      <!-- Favicon -->
                      ...
                      <div class="sign-in-from w-100 m-auto">
                          ...
                          <form class="mt-4" method="post">
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control mb-0" name="name" id="exampleInputEmail1" placeholder="Your Full Name">
                              </div>
                              <div class="form-group">
                                <label for="exampleInputEmail1">Username</label>
                                <input type="text" class="form-control mb-0" name="username" id="exampleInputEmail1" placeholder="Username">
                            </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <input type="number" class="form-control mb-0" name="phone" id="exampleInputEmail2" placeholder="Enter phone">
                            </div>
                              <div class="form-group">
                              ...
                              <div class="sign-info">
                                  <button type="submit" id="signup-btn" class="btn btn-primary mb-2">Sign Up</button>

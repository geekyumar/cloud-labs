...
<html lang="en">
   <head>
      ...
      <title>Manage MySQL - Cloud Labs</title>
      <!-- Favicon -->
   ...
   <body class="sidebar-main-active right-column-fixed">
      ...
      <div class="wrapper">
            ...
            <div class="iq-navbar-custom">
               <nav class="navbar navbar-expand-lg navbar-light p-0">
                  ...
                  <div class="navbar-breadcrumb">
                     <h4 class="mb-0 text-dark">Manage MySQL</h4>
                     <p class="mb-0">Manage your MySQL users here.</p>
                  </div>
         ...
         <div id="content-page" class="content-page">
            <div class="mb-0 pl-3">
                <p >Total databases: <span class="text-danger">2/5</span></p>
                <button type="submit" href="#" class="btn btn-primary">Add database</button>
            </div>
            <br>
            <div class="col-sm-6">
                <div class="iq-card  iq-mb-3">
                   <div class="iq-card-body">
                      <h4 class="card-title">MySQL Server Details</h4>
                      <br>
                      <p class="card-text">Servername: <span class="text-danger">mysql.umarfarooq.cloud</span></p>
                      <p class="card-text">IP Address <span class="text-danger">192.168.0.5</span></p>
                      <p class="card-text">Hostname: <span class="text-danger">mysql.umarfarooq.cloud:3306</span></p>
                      <p class="card-text">Port: <span class="text-danger">3306</span></p>
                   </div>
                </div>
             </div>
                  ...
                  <div class="col-lg-12">
                    <div class="row">
                        <div class="col-sm-6">
                           <div class="iq-card  iq-mb-3">
                              <div class="iq-card-body">
                                 <h4 class="card-title">umarfarooq98</h4>
                                 <div id="device-config" class="d-none">
                                 <p class="card-text">Password: <span class="text-danger">helloworld</span></p>
                                </div>
                                <br>
                                 <button type="submit" href="#" id="show-config" class="btn btn-primary">Click to view password</button>
                                 <button type="submit" href="#" class="btn btn-primary">Delete database</button>
